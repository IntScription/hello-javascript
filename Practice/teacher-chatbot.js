...
console.log(learningIsFunSentence.indexOf('fun')); // returns 12
console.log(learningIsFunSentence.indexOf('learning')); // returns -1 [NOTE: JavaScript is case-sensitive]
